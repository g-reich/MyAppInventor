...
public interface AutogeneratedOdeMessages extends Messages {
  ...
  @DefaultMessage("Set the points of the LineString from a specially-coded character string of the form: [[longitude1, latitude1], [longitude2, latitude2], ...] Note the reversal of latitude and longitude versus how they are typically represented.")
  @Description("")
